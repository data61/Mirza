...
import           Mirza.OrgRegistry.Database.Schema.V0002 as Current hiding
                                                                     (migration)
...
migration :: MigrationSteps Postgres () (CheckedDatabaseSettings Postgres Current.OrgRegistryDB)
